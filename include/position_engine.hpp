...
// Position engine - material + piece-square-table evaluation with iterative deepening.
class PositionEngine : public Engine {
public:
    ...
    std::string name() const override { return "PositionEngine"; }
