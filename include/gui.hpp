...
private:
    ...
    void draw_promotion_dialog(sf::RenderWindow& window);
    void draw_text(sf::RenderWindow& window, const std::string& text, int x, int y, int size, sf::Color color, sf::Text::Style style = sf::Text::Style::Regular);
    ...
    std::optional<int> promotion_from_;
    std::optional<int> promotion_to_;
};
